    ...
    handlers: {
      GET: async () => {
        const staticPaths: SitemapEntry[] = [
          ...
          { path: "/video-gallery", changefreq: "monthly", priority: "0.5" },
          { path: "/reviews", changefreq: "weekly", priority: "0.6" },
          { path: "/faq", changefreq: "monthly", priority: "0.5" },
          { path: "/care-guide", changefreq: "monthly", priority: "0.5" },
        ...
        const entries: SitemapEntry[] = [
          ...staticPaths,
          ...categories.map((c) => ({ path: `/categories/${c.slug}`, changefreq: "weekly" as const, priority: "0.8" })),
          ...products.map((p) => ({ path: `/products/${p.slug}`, changefreq: "weekly" as const, priority: "0.7" })),
