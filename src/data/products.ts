...
export const products: Product[] = [
  ...
  // ── Bonsai (4) ──
  ...mk("bonsai", [
    ["ficus-bonsai", "ফিকাস বনসাই", 1850, "photo-1485955900006-10f4d324d411", "সহজ যত্নের জনপ্রিয় বনসাই।"],
    ["juniper-bonsai", "জুনিপার বনসাই", 2450, "photo-1485955900006-10f4d324d411", "ক্লাসিক জাপানি বনসাই।"],
    ["jade-bonsai", "জেড বনসাই", 1450, "photo-1485955900006-10f4d324d411", "সৌভাগ্যের রসালো বনসাই।"],
    ["banyan-bonsai", "বট বনসাই", 2850, "photo-1485955900006-10f4d324d411", "ঐতিহ্যবাহী বট বনসাই।"],
  ]),
  // ── Palm (4) ──
  ...mk("palm", [
    ["coconut-palm", "নারিকেল চারা", 380, "photo-1485955900006-10f4d324d411", "উচ্চ ফলনশীল নারিকেল গাছ।"],
    ["date-palm", "খেজুর চারা", 480, "photo-1485955900006-10f4d324d411", "মিষ্টি খেজুর জাত।"],
    ["fishtail-palm", "ফিশটেইল পাম", 850, "photo-1485955900006-10f4d324d411", "অলংকারিক ইনডোর পাম।"],
    ["kentia-palm", "কেন্টিয়া পাম", 1250, "photo-1485955900006-10f4d324d411", "মার্জিত ইনডোর পাম।"],
  ]),
  // ── Succulent (4) ──
  ...mk("succulent", [
    ["echeveria", "ইচেভেরিয়া", 220, "photo-1593482892290-f54927ae1bb6", "গোলাপ আকৃতির রসালো।"],
    ["jade-plant", "জেড প্ল্যান্ট", 280, "photo-1593482892290-f54927ae1bb6", "সৌভাগ্য আনয়নকারী রসালো।"],
    ["golden-barrel-cactus", "গোল্ডেন ব্যারেল ক্যাকটাস", 450, "photo-1593482892290-f54927ae1bb6", "ক্লাসিক গোলাকার ক্যাকটাস।"],
    ["string-of-pearls", "স্ট্রিং অব পার্লস", 380, "photo-1593482892290-f54927ae1bb6", "মুক্তামালা ঝুলন্ত রসালো।"],
  ]),
  // ── Medicinal (4) ──
  ...mk("medicinal", [
    ["tulsi-rama", "রাম তুলসী", 120, "photo-1466692476868-aef1dfb1e735", "পবিত্র সবুজ তুলসী।"],
    ["brahmi", "ব্রাহ্মী", 180, "photo-1466692476868-aef1dfb1e735", "স্মৃতিশক্তি বর্ধক ভেষজ।"],
    ["giloy", "গিলয়", 220, "photo-1466692476868-aef1dfb1e735", "রোগ প্রতিরোধক লতা।"],
    ["shatavari", "শতমূলী", 280, "photo-1466692476868-aef1dfb1e735", "আয়ুর্বেদিক শক্তিদায়ক।"],
  ]),
  // ── Vegetable (4) ──
  ...mk("vegetable", [
    ["tomato-sapling", "টমেটো চারা", 80, "photo-1466692476868-aef1dfb1e735", "উচ্চ ফলনশীল হাইব্রিড টমেটো।"],
    ["chili-sapling", "মরিচ চারা", 70, "photo-1466692476868-aef1dfb1e735", "ঝাল দেশি মরিচের চারা।"],
    ["brinjal-sapling", "বেগুন চারা", 90, "photo-1466692476868-aef1dfb1e735", "বেগুনি লম্বা বেগুন।"],
    ["capsicum-sapling", "ক্যাপসিকাম চারা", 120, "photo-1466692476868-aef1dfb1e735", "রঙিন বেল পেপার।"],
  ]),
  // ── Timber (4) ──
  ...mk("timber", [
    ["teak-tree", "সেগুন গাছ", 250, "photo-1485955900006-10f4d324d411", "মূল্যবান কাঠের রাজা।"],
    ["mahogany-tree", "মেহগনি গাছ", 320, "photo-1485955900006-10f4d324d411", "প্রিমিয়াম আসবাব কাঠ।"],
    ["sissoo-tree", "শিশু গাছ", 180, "photo-1485955900006-10f4d324d411", "দ্রুত বর্ধনশীল কাঠের গাছ।"],
    ["eucalyptus-tree", "ইউক্যালিপটাস", 150, "photo-1485955900006-10f4d324d411", "দ্রুত বর্ধনশীল বাণিজ্যিক গাছ।"],
  ]),
  // ── Bamboo (4) ──
  ...mk("bamboo", [
    ["golden-bamboo", "সোনালি বাঁশ", 380, "photo-1485955900006-10f4d324d411", "সাজসজ্জার সোনালি বাঁশ।"],
    ["buddha-belly-bamboo", "বুদ্ধ বেলি বাঁশ", 650, "photo-1485955900006-10f4d324d411", "অলংকারিক দুর্লভ বাঁশ।"],
    ["lucky-bamboo", "লাকি বাঁশ", 220, "photo-1485955900006-10f4d324d411", "ফেং শুই সৌভাগ্যের গাছ।"],
    ["black-bamboo", "কালো বাঁশ", 750, "photo-1485955900006-10f4d324d411", "বিরল কালো কান্ডের বাঁশ।"],
  ]),
  // ── Aquatic (4) ──
  ...mk("aquatic", [
    ["pink-lotus", "গোলাপি পদ্ম", 480, "photo-1490750967868-88aa4486c946", "পবিত্র গোলাপি পদ্মফুল।"],
    ["water-lily", "সাদা শাপলা", 380, "photo-1490750967868-88aa4486c946", "জাতীয় ফুল সাদা শাপলা।"],
    ["water-hyacinth", "কচুরিপানা", 150, "photo-1490750967868-88aa4486c946", "বেগুনি ফুলের জলজ গাছ।"],
    ["papyrus", "প্যাপিরাস", 320, "photo-1490750967868-88aa4486c946", "মিশরীয় জলজ ঘাস।"],
  ]),
];
